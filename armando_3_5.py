...
#analyze the first monologue for sentiment and key phrases
...
# Hold the dialogue from scenes

# Use Generator to craft a prompt which includes all these elements

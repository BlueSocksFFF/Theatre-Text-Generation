...
write_to_api("write a monologue about your first time surfing. Make it personal and anecdotal, with a sad ending, but hopeful themes throughout.", "avatar_prompts")
###

type_of_generator = gpt3 
prompt_file = "avatar_prompts" ##write_to_api generated an "avatar_prompts" file when I first wrote to it
prompt = pull_down_prompt(prompt_file)
